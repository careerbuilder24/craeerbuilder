      ...
      <div className='lg:mt-52 bg-gray-100 h-full w-10/12 lg:w-7/12 container mx-auto mb-10'>
        ...
        <div className='flex flex-col lg:flex-row justify-between mt-10'>
          <div className='lg:ml-96'>
            <h1 className='text-4xl font-bold mb-6 text-[#2CAAE1] mt-5'>Running Interns</h1>
          </div>
        ...
        >
          <div ref={sidebarRef} className="w-44 bg-[#17549A] text-white h-full">
            <h2 className="text-lg font-bold mb-4 text-center ">Running Interns</h2> {/* Add margin bottom here */}
