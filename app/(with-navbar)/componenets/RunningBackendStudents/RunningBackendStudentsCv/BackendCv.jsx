...
export default function CuriculamVite() {
    ...
    const useBackendDevelopment = useBackend();

   
      const useBackendDevelopments = useBackendDevelopment.find(Onestudent => Onestudent?.id === Number(id));
    // console.log(motion)
    return (
        <>
            <div className='flex flex-col-reverse lg:flex-row '>
                ...
                <div className='bg-[#44b5e6] lg:w-4/12    rounded-lg '>
                    ...
                    {useBackendDevelopments ? (
                        <div className='flex flex-col   w-full h-full '>
                            <div className='w-ful mt-4 text-white'>
                                <img
                                    src={useBackendDevelopments?.image}
                                    onDragStart={(e) => e.preventDefault()}
                                    alt={useBackendDevelopments?.title}
                                ...
                                />
                                <p className='text-center text-2xl font-bold'>{useBackendDevelopments.name}</p>
