...
export default function CuriculamVite() {
    ...
    const businessDEvelopment = businesses.find(Onestudent => Onestudent?.id === Number(id));
                    ...
                    {businessDEvelopment ? (
                        <div className='flex flex-col   w-full h-full '>
                            <div className='w-ful mt-4 text-white'>
                                <Image
                                    src={businessDEvelopment?.image}
                                    onDragStart={(e) => e.preventDefault()}
                                    alt={businessDEvelopment?.title}
                                ...
                                />
                                <p className='text-center text-2xl font-bold'>{businessDEvelopment.name}</p>
