...
export default function Banner() {
    ...
    return (
        <>
            ...
            <div className=" relative w-full mt-16 lg:mt-0 "> {/* Adjusted top margin */}
                <Carousel
                ...
                >
                    ...
                    {[img, img2, img4, img5].map((src, index) => (
                        <div
                            key={index}
                            className="flex justify-center mt-24 items-center w-full h-[29vh] md:h-[50vh] lg:h-[100vh]  " // Centers content
                        >
                            <Image
                                src={src}
                                alt={`Slide ${index + 1}`}
