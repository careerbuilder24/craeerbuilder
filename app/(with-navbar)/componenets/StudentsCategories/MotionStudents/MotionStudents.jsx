...
const MotionStudents = ({ motions, searchQuery, currentPage, handlePageChange }) => {
  const itemsPerPage = 12;

  // Function to apply search and pagination for motion students
  ...
  const { currentData, totalPages } = applySearchAndPagination(motions || []);
