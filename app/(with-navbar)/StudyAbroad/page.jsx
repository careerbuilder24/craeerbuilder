...
export default function UniversityPage() {
  ...
  return (
    <>
      ...
      <main>
        <Navbar />
        <section className='mt-28 bg-gray-100 w-11/12 lg:w-8/12 container mx-auto mb-10'>
                          ...
                          <section className='mt-4 space-y-6'>
                            ...
                            <div className='flex flex-col lg:flex-row gap-6'>
                              <div className='lg:w-1/2'>
                                ...
                                <Image src={university.imageTwo} width={600} height={400} className='rounded shadow mt-2' alt={`${university.name} image 2`} />
                              </div>
                              <div className='lg:w-1/2'>
                                <Image src={university.imageThree} width={600} height={400} className='rounded shadow mb-2' alt={`${university.name} image 3`} />
                            ...
                            <div className='flex flex-col-reverse lg:flex-row gap-6'>
                              ...
                              <Image src={university.imageFour} width={600} height={400} className='rounded shadow lg:w-1/2' alt={`${university.name} image 4`} />
                            </div>
                          </section>
                        )}
                      </article>
