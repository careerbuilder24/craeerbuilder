...
// import logo from '../../../assets/user-welcome-text.gif'
...
// 👉 You can use any free JSON from lottiefiles.com
import welcomeAnimation from "../../../assets/Welcome (1).json"; 
  ...
  useEffect(() => {
    ...
    if (metaDescription) {
      metaDescription.setAttribute(
        "content",
        "Welcome to Career Builder, the platform to help you grow your career with professional development tools, CV updates, and more."
      );
    }
    ...
    if (metaKeywords) {
      metaKeywords.setAttribute(
        "content",
        "Career Builder, professional development, career growth, CV updates, portfolio, job search"
      );
    }
    ...
    if (metaOgTitle) {
      metaOgTitle.setAttribute(
        "content",
        "Welcome to Career Builder - Elevate Your Career"
      );
    }
    ...
    if (metaOgImage) {
      metaOgImage.setAttribute(
        "content",
        "https://i.postimg.cc/s2RQWVG5/gilbert.png"
      );
    }
    ...
    <>
      ...
      <div className="welcome-page">
        <div className="welcome-animation">
          <Lottie className="w-ful" animationData={welcomeAnimation} loop={true} />
        </div>
      </div>
