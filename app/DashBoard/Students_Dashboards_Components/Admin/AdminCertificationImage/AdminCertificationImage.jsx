...
export default function AdminCertificationImage() {
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      await axios.post('/api/certification-image', { imageUrl: uploadedUrl, title: title.trim() })
  ...
  const handleDelete = async (id) => {
    ...
    if (result.isConfirmed) {
      try {
        await axios.delete(`/api/certification-image?id=${id}`)
  ...
  return (
    <div className="max-w-6xl mx-auto p-4">
      <h2 className="font-bold mb-6 text-center text-2xl"> Certification Images</h2>

      <div className="flex flex-col md:flex-row gap-6">
        {/* Upload Form */}
        <div className="p-4 w-full md:w-1/3 order-1 md:order-2">
          <input
            type="text"
        ...
        {/* Uploaded Images */}
        <div className="p-4 overflow-y-auto max-h-[600px] flex-1 order-2 md:order-1">
      ...
      {modalData && (
        ...
        >
          ...
          >
            ...
            {/* Optional: If you have created_at or similar */}
            {/* <p className="text-gray-600 text-sm">Uploaded at: {modalData.created_at}</p> */}
          </div>
        </div>
      )}
    </div>
