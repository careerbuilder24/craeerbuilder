...
export default function News() {
    ...
    const handleUpload = async () => {
        ...
        try {
            ...
            await axios.post('/api/news-images', { imageUrl: uploadedUrl, title: title.trim() })
    ...
    const handleDelete = async (id) => {
        ...
        if (result.isConfirmed) {
            try {
                await axios.delete(`/api/news-images?id=${id}`)
    ...
    const handleModalOverlayClick = (e) => {
        if (e.target.id === 'modalOverlay') setModalData(null)
    }

    return (
        <div className="max-w-6xl mx-auto p-4">
            <h2 className="font-bold mb-6 text-center text-2xl">News Images</h2>
                        ...
                        <div className="flex flex-wrap gap-4">
                            {images.map((img) => (
                                <div
                                    ...
                                    onClick={() =>
                                        setModalData({ image_url: img.image_url, title: img.title })
                                    }
                                >
                                    <img
                                        src={img.image_url}
