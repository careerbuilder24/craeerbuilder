...
import useAllAbroadUniversityApplicant from '@/hooks/useAllAbroadUniversityApplicant'; // adjust path

export default function AllAbroadUniversityApplicant() {
    ...
    return (
        <div className="container mx-auto p-4 sm:px-6 lg:px-20">
            <h1 className="text-2xl font-bold mb-4 text-left">University Applications</h1>
                        ...
                        {applications.map((app, index) => (
                            <tr key={app.id} className={index % 2 === 0 ? 'bg-gray-100' : ''}>
                                ...
                                <td className="py-2 px-4 border">
                                    <span
                                        className={`px-2 py-1 rounded text-white ${app.status === 'Pending'
                                            ? 'bg-yellow-500'
                                            : app.status === 'Accepted'
                                                ? 'bg-green-600'
                                                : 'bg-red-600'
                                ...
                                <td className=" px-4 border relative py-10">
                                    <div className="inline-block relative">
                                        ...
                                        {openActionId === app.id && (
                                            <div className="absolute right-6 bottom-[20%] bg-white border border-gray-200 shadow-md rounded-lg w-32 py-1 z-50">
                                                <button
                    ...
                    <div key={app.id} className="border border-gray-300 rounded-lg p-4 bg-white shadow-sm">
                        <div className="flex justify-between items-start">
                            <div>
                                ...
                                <span
                                    className={`inline-block mt-1 px-2 py-1 rounded text-white ${app.status === 'Pending'
                                        ? 'bg-yellow-500'
                                        : app.status === 'Accepted'
                                            ? 'bg-green-600'
                                            : 'bg-red-600'
