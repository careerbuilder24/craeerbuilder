...
export default function UploadCharityImage() {
    ...
    const handleUpload = async () => {
        ...
        try {
            ...
            await axios.post('/api/charity-images', { imageUrl: uploadedUrl, title: title.trim() })
    ...
    const handleDelete = async (id) => {
        ...
        if (result.isConfirmed) {
            try {
                await axios.delete(`/api/charity-images?id=${id}`)
    ...
    return (
        <div className="max-w-6xl mx-auto p-4">
            <h2 className="font-bold mb-6 text-center text-2xl">Upload Charity Images</h2>
