...
export default function EidUlAdha() {
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      await axios.post('/api/eid_ul_adha_images', {
  ...
  const handleDelete = async (id) => {
    ...
    if (result.isConfirmed) {
      try {
        await axios.delete(`/api/eid_ul_adha_images?id=${id}`)
  ...
  return (
    <div className="max-w-6xl mx-auto p-4">
      <h2 className="font-bold mb-6 text-center text-2xl">Eid Ul Adha Images</h2>
