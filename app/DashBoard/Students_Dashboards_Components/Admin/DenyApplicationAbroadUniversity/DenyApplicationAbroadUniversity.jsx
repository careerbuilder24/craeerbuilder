...
export default function DenyApplicationAbroadUniversity() {
    const { applications, loading, setApplications } = useAllAbroadUniversityApplicant();
    const [openActionId, setOpenActionId] = useState(null);

    // Filter only Denied applications
    const deniedApplications = applications.filter(app => app.status === 'Denied');
    ...
    return (
        <div className="container mx-auto p-4 sm:px-6 lg:px-20">
            <h1 className="text-2xl font-bold mb-4 text-left">Denied University Applications</h1>
            ...
            <div className="hidden md:block overflow-x-auto">
                <table className="min-w-full border border-gray-300 text-center">
                    ...
                    <tbody>
                        {deniedApplications.map((app, index) => (
                    ...
                    <div key={app.id} className="border border-gray-300 rounded-lg p-4 bg-white shadow-sm">
                        <div className="flex justify-between items-start">
                            <div>
                                ...
                                <span className="inline-block mt-1 px-2 py-1 rounded text-white bg-red-600">
                                    {app.status}
                                </span>
                            </div>
