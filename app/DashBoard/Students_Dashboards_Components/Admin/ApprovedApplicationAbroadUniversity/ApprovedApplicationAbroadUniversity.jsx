...
export default function ApprovedApplicationAbroadUniversity() {
    ...
    return (
        <div className="container mx-auto p-4 sm:px-6 lg:px-20">
            <h1 className="text-2xl font-bold mb-4 text-left">Accepted University Applications</h1>
                    ...
                    <div key={app.id} className="border border-gray-300 rounded-lg p-4 bg-white shadow-sm">
                        <div className="flex justify-between items-start">
                            <div>
                                ...
                                <span className="inline-block mt-1 px-2 py-1 rounded text-white bg-green-600">
                                    {app.status}
                                </span>
                            </div>
