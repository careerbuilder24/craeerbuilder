...
export default function EidUlFitre() {
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      // Save to backend
      await axios.post('/api/EidulfitreImages', {
  ...
  const handleDelete = async (id) => {
    ...
    if (result.isConfirmed) {
      try {
        await axios.delete(`/api/eid-ul-fitre?id=${id}`)
  ...
  return (
    <div className="max-w-6xl mx-auto p-4">
      <h2 className="font-bold mb-6 text-center text-2xl">Eid Ul Fitre Images</h2>
