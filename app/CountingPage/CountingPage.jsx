...
export default function CountingPage() {
    return (
        <main>
            <div className='container mx-auto flex flex-row gap-6 text-center my-16 text-white'>
                <div className='flex flex-col items-center w-72 h-44 bg-[#2CAAE1] rounded-md justify-center'>
