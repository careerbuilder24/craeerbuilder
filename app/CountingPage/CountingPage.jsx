...
export default function CountingPage() {
    return (
        <main>
            <div className='container mx-auto flex flex-col  lg:flex-row lg:w-8/12 w-5/12 text-center my-16 gap-2 text-white '>
                <div className='flex flex-col  items-center w-full h-44  lg:ml-0 bg-[#2CAAE1] rounded-md justify-center'>
                    <PiStudentFill className='text-2xl mb-1' />
                    <p className='text-base font-bold'>Running Students</p>
                    <Counter target={200} />
                </div>

                <div className='flex flex-col  items-center w-full h-44 bg-[#2CAAE1] rounded-md justify-center'>
