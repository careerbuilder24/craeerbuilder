...
export const metadata = {
  ...
  description:
    "Explore expert resources, job tips, and educational content to build your career effectively.",
  keywords: [
    "career builder",
    "job tips",
    "career development",
  ...
  twitter: {
    ...
    description:
      "Explore expert resources, job tips, and educational content to build your career.",
  },
  verification: {
