...
export async function POST(req) {
  try {
    ...
    const { name, maritalStatus, email, phone, address, permanentAddress, facebook, linkedin, aboutMyself, uploadedImage, category } = body;

    if (!name || !maritalStatus || !email || !phone || !address || !permanentAddress || !facebook || !linkedin || !aboutMyself || !uploadedImage || !category) {
    ...
    const query = `
      INSERT INTO users_login.edit_profile
      (name, maritalStatus, email, phone, address, permanentAddress, facebook, linkedin, aboutMyself, uploadedImage, category)
      VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
    `;
    const values = [name, maritalStatus, email, phone, address, permanentAddress, facebook, linkedin, aboutMyself, uploadedImage, category];
